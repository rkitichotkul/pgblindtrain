...
def generate_datasets(rootdir, num_train=None, num_val=None, num_test=None, train_window=40):
    ...
    Note:
        The dataset used here is from DnCNN git repository:
        https://github.com/SaoYan/DnCNN-PyTorch. The organization is
            - data
                - val (Set12)
                    - 01.png
                    - ...
                ...
                - train
                    ...
                    - ...
                    - test_400.png
    Save the resulting .h5 files to rootdir directory. Overwrite
    Modify this function if you use other datasets!
    ...
    loadlist = generate_loadlist(os.path.join(rootdir, 'test'), num_files=num_test)
